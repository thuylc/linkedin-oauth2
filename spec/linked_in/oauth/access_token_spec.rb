describe "LinkedInOauth2::AccessToken" do
  ...
  context "When everything is set" do
    subject {LinkedInOauth2::AccessToken.new(tok, expires_in, expires_at)}
